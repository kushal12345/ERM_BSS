...
const Navbar = ({loginuser}) => {
  ...
  return (
    <div className='w-full h-full  bg-white dark:bg-[#212528]  overflow-hidden no-scrollbar'>
        <nav className="   overflow-hidden no-scrollbar dark:shadow-lg">
                ...
                <div className="flex  items-center justify-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <>
                      <Dropdown
                        ...
                        renderTrigger={() => (
                        <button
                            className="group border border-1 flex items-center p-2 rounded-lg transition-colors duration-200 
                        ...
                        size="sm"
                    >
                        <DropdownItem>* New Message from Chinkaji Kumal</DropdownItem>
